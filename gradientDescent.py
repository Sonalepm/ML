...
#stop_cond = 0.001 # stop_cond for toy dataset 
#eta = 0.000000001  # stop cond for breast_cancer dataset

prev_error = float('inf') 
#print("prev_error",prev_error)
cond = True
max_iter = 0
while(cond == True and max_iter <100000):
	max_iter +=1
	del_w = []
	for j in range(0,cols,1):
		del_w.append(0)
...
abs_dist = abs(w[0]/norw)
#print("abs(w0/||w||) = ", abs_dist)
